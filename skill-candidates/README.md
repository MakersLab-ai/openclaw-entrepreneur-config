...
Skills in diesem Ordner sind **nicht Teil des Starter-Sets** und werden vom Admin-Agent
...
hinaus ist optional und integrations-spezifisch — also nicht für jeden Kunden relevant.
...
Es gibt keinen automatischen Installer-Pfad aus diesem Ordner — bewusst, das hält den
Starter-Pfad sauber. Zum Aktivieren manuell kopieren:
...
Kunde eines dieser Tools einführt. Hier liegen sie griffbereit, ohne den Default-Pfad zu
belasten.
